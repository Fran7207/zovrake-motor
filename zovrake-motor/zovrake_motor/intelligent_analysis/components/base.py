"""Contratos base de componentes internos de Razonamiento Inteligente."""
...
class IntelligentAnalysisComponentPort(ABC):
    """
    Contrato base para componentes del módulo de Razonamiento Inteligente.
