"""Almacén en memoria de catálogos de proveedores organizados."""
...
class OrganizedProviderCatalogStore:
    """Almacén temporal de catálogos de proveedores — sin persistencia."""

    def __init__(self) -> None:
        self._catalogs_by_id: dict[str, OrganizedProviderCatalog] = {}
        self._catalog_ids_by_process: dict[UUID, list[str]] = {}

    def save(self, catalog: OrganizedProviderCatalog) -> None:
    ...
    def get(self, catalog_id: str) -> OrganizedProviderCatalog | None:
        return self._catalogs_by_id.get(catalog_id)

    def get_by_process(self, process_id: UUID) -> tuple[OrganizedProviderCatalog, ...]:
