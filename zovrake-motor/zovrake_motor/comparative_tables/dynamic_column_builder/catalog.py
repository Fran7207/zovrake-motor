"""Almacén en memoria de catálogos de columnas dinámicas."""
...
class ComparativeTableColumnCatalogStore:
    """Almacén temporal de catálogos de columnas — sin persistencia."""

    def __init__(self) -> None:
        self._catalogs_by_id: dict[str, ComparativeTableColumnCatalog] = {}
        self._catalog_ids_by_process: dict[UUID, list[str]] = {}

    def save(self, catalog: ComparativeTableColumnCatalog) -> None:
    ...
    def get(self, catalog_id: str) -> ComparativeTableColumnCatalog | None:
        return self._catalogs_by_id.get(catalog_id)

    def get_by_process(self, process_id: UUID) -> tuple[ComparativeTableColumnCatalog, ...]:
