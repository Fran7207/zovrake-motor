"""Almacén en memoria de catálogos de filas dinámicas."""
...
class ComparativeTableRowCatalogStore:
    """Almacén temporal de catálogos de filas — sin persistencia."""

    def __init__(self) -> None:
        self._catalogs_by_id: dict[str, ComparativeTableRowCatalog] = {}
        self._catalog_ids_by_process: dict[UUID, list[str]] = {}

    def save(self, catalog: ComparativeTableRowCatalog) -> None:
    ...
    def get(self, catalog_id: str) -> ComparativeTableRowCatalog | None:
        return self._catalogs_by_id.get(catalog_id)

    def get_by_process(self, process_id: UUID) -> tuple[ComparativeTableRowCatalog, ...]:
