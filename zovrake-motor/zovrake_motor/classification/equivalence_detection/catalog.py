"""Almacén en memoria de catálogos de equivalencias."""
...
class EquivalenceCatalogStore:
    """Almacén temporal de catálogos de equivalencias — sin persistencia."""

    def __init__(self) -> None:
        self._catalogs_by_id: dict[str, EquivalenceCatalog] = {}
        self._catalog_ids_by_process: dict[UUID, list[str]] = {}

    def save(self, catalog: EquivalenceCatalog) -> None:
    ...
    def get(self, catalog_id: str) -> EquivalenceCatalog | None:
        return self._catalogs_by_id.get(catalog_id)

    def get_by_process(self, process_id: UUID) -> tuple[EquivalenceCatalog, ...]:
