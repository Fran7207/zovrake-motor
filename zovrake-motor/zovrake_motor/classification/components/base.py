"""Contratos base de componentes internos de Clasificación Inteligente."""
...
class ClassificationComponentPort(ABC):
    """
    Contrato base para componentes del módulo de Clasificación Inteligente.
