"""Almacén en memoria de informes de validación de calidad."""
...
from zovrake_motor.classification.classification_quality.models import ClassificationQualityReport


class ClassificationQualityReportStore:
    """Almacén temporal de informes — sin persistencia."""

    def __init__(self) -> None:
        self._reports_by_id: dict[str, ClassificationQualityReport] = {}
        self._report_ids_by_process: dict[UUID, list[str]] = {}

    def save(self, report: ClassificationQualityReport) -> None:
    ...
    def get(self, report_id: str) -> ClassificationQualityReport | None:
        return self._reports_by_id.get(report_id)

    def get_by_process(self, process_id: UUID) -> tuple[ClassificationQualityReport, ...]:
