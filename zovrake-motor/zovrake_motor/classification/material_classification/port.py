"""Contrato base de clasificadores del Material Classification Engine."""
...
class MaterialClassifierPort(ABC):
    """
    Contrato común para clasificadores de materiales.

    Cada clasificador identifica materiales de un tipo de concepto del CAE.
    """
    ...
    def classify(self, catalog_view: ConceptCatalogView, *, start_sequence: int) -> ClassifierResult:
        """Clasifica materiales — sin modificar el catálogo de conceptos."""
